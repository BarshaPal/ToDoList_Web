...
app.get("/",function(req,res){
  res.render("home",{homeContent:homeStartingContent,data:posts});
});
...
app.get("/posts/:postName", (req, res) => {
  posts.forEach((i)=>
{
  if(_.lowerCase(req.params.postName)===_.lowerCase(i.title)){
    res.render("post",{title:i.title,post:i.post});
  }
  else{
